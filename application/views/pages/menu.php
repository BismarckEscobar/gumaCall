           ...
           <ul class="nav menu demo-navigation mdl-navigation__link" >
            <?php
              switch ($this->session->userdata('RolUser')) {
                case '1':
                  $menu = '<a href="Campania"><li href="Campania"><i class="material-icons">trending_up</i> campaña</li></a>
                           <a href="Main"><li href="#"><i class="material-icons">trending_up</i> Monitoreo</li></a>
                           ...
                           <a href="#"><li href="#"><i class="material-icons">equalizer</i> Clientes</li></a>
                           <a href="#"><li href="#"><i class="material-icons">insert_chart</i> Reportes</li></a>
